	...
	<head>
		...
		jQuery(document).ready(function(){
		    jQuery('#hideshow').live('click', function(event) {        
		         jQuery('#Reel-Player-BG').toggle('show');
		    });
		});
		</script>
				...
				<div class="container">
					...
					<nav class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item current-menu-item"><a href="gallery.jsp">Gallery</a></li>
							...
							<div class="filterable-items">
								<div class="filterable-item concert">
									<a href="dummy/large-gallery/gallery-1.jpg">
										<figure><img src="dummy/gallery-1.jpg" alt="gallery 1">
											<a href="cartcontroller" class="button small primary">Add To Cart</a>
											<a href="musicplayer.jsp" class="button small secondary">Listen To</a>
										</figure>
									</a>
								</div>
								<div class="filterable-item concert">
									<a href="dummy/large-gallery/gallery-2.jpg">
										<figure><img src="dummy/gallery-2.jpg" alt="gallery 2">
											<a href="cartcontroller" class="button small primary">Add To Cart</a>
											<a href="musicplayer.jsp" class="button small secondary">Listen To</a>
										</figure>
									</a>
								...
								<div class="filterable-item stuff">
									<!-- <a href="dummy/large-gallery/gallery-3.jpg"> -->
										<figure><img src="dummy/gallery-3.jpg" alt="gallery 3">
												<form action="cartController" method='post'>
												<input type="hidden" name="musicname" value="tammatamma">
												<input type="hidden" name="musicid" value="1001">
												<button type="submit" class="button small primary">Add To Cart</button>
												</form>
												<form action="musicplayer.jsp">
												<button class="button small secondary">Listen To</button>
												</form>
										</figure>
									<!-- </a> -->
								</div>
								<div class="filterable-item concert">
									<a href="dummy/large-gallery/gallery-4.jpg">
										<figure><img src="dummy/gallery-4.jpg" alt="gallery 4">
											<a href="cartcontroller" class="button small primary">Add To Cart</a>
											<a href="musicplayer.jsp" class="button small secondary">Listen To</a>
										</figure>
									</a>
